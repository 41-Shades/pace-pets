...
function commonRuntimeDependencyEdges() {
  return Object.freeze([
    ...
    dependencyEdge("usage-windows.js", "held-zero-state.js"),
    dependencyEdge("usage-values.js", "usage.js"),
    dependencyEdge("usage-values.js", "held-zero-state.js"),
    dependencyEdge("usage-values.js", "history-store.js"),
    dependencyEdge("held-zero-state.js", "refresh-status.js"),
    ...
    dependencyEdge("pace-logic.js", "pace-presentation.js"),
    dependencyEdge("pace-presentation.js", "pace-window-history.js"),
...
function dashboardFoundationDependencyEdges() {
  return [
    ...
    dependencyEdge("./pace-logic.js", "./dashboard-chart-readout.js"),
    dashboardFileEdge("chart-data", "chart-readout"),
    dashboardFileEdge("chart-data", "chart-config"),
    dashboardFileEdge("chart-readout", "chart"),
    dashboardFileEdge("chart-config", "chart"),
    ...
    pageEdge("perfect-zero-space-draw.js", "perfect-zero-space-backdrop.js"),
    pageEdge("perfect-zero-space-backdrop.js", "perfect-zero-space-scene.js"),
    ...
    ...[
      "push-stretch-renderer",
      "push-sweat-renderer",
      "push-water-renderer",
    ].map((after) => dashboardFileEdge("push-canvas-layout", after)),
...
function dashboardPresentationDependencyEdges() {
  return [
    ...
    dashboardFileEdge("app-core", "history-timing-methods"),
    dashboardFileEdge("history-timing-methods", "history-methods"),
    pageEdge("pace-logic.js", "dashboard-history-timing-methods.js"),
    pageEdge("pace-window-history.js", "dashboard-refresh-scheduler.js"),
    ...
    dashboardFileEdge("history-methods", "refresh-scheduler"),
    dashboardFileEdge("refresh-scheduler", "event-methods"),
    dashboardFileEdge("refresh-scheduler", ""),
