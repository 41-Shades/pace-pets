...
icon to choose an available badge view. Pace Pets offers only the usage windows
reported by the signed-in account's latest successful check; a reported
300-minute window makes the 5h view available.
